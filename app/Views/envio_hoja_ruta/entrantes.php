...
<div class="row">
    <div class="col">
        <div class="section-description section-description-inline px-0">
            <h1>Entrantes</h1>
            <span>Listado de entrantes</span>
        </div>
        <div class="card">
            <div class="card-body">
                <table id="listado-entrantes" class="display" style="width: 100%; font-size:13px;">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Oficina</th>
...
<script src="<?= base_url('/neptune/source/assets/js/envio_hoja_ruta/entrantes.js') ?>"></script>
<?= $this->endSection() ?>
